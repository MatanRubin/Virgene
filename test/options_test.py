...
def test_boolean_option_set():
    bool_opt = BooleanOption("my_bool_opt", None, True, "stam")
    bool_opt.set_value(False)
    assert bool_opt.value is False


def test_choice_option_set():
    choice_opt = ChoiceOption("choice option", None, "A", "choose A,B,C")
...
def test_boolean_option_bad_default_value():
    with pytest.raises(ValueError):
        bool_opt = BooleanOption("my_bool_opt", None, "bad default", "stam")


def test_choice_option_bad_default_value():
    with pytest.raises(ValueError):
        choice_opt = ChoiceOption("choice option", None, "bad default",
                                  "choose A,B,C")

def test_bool_encode_decode():
    bool_opt = BooleanOption("bool opt", None, True, "bool for encode")
...
def test_choice_encode_decode():
    choice_opt = ChoiceOption("choice opt", None, "A", "bool for encode")
